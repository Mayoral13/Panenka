...
const Header = () => {
const { dropdownRef, toggleDropdown, handleOptionClick, isOpen, PageStatus} = useContext(Context)
if(PageStatus === "MY SQUAD"){
  return (
          ...
          <div className="nav">
            <div className='d-flex align-items-center'>
              ...
              {isOpen && (
                <div className="dropdown-content" ref={dropdownRef}>
                  {/* Dropdown Content */}
                  <Link style={{color:'white'}} onClick={handleOptionClick} to = "/">MY SQUAD</Link>
